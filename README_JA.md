> **jzg-lab custom distribution:** See [repository maintenance and source builds](docs/REPOSITORY_MAINTENANCE.md) before deployment. The upstream images and install commands below do not deploy this custom version.
