export default {
    accounts: {
      ...
      openai: {
        ...
        basispointsMode: 'Basispoints outbound mode',
        basispointsModeDesc:
          'Disabled by default. When enabled, this account\'s /v1/responses requests go to the basispoints endpoint on bps.openai.com instead of the chatgpt.com Codex endpoint, without Codex identity headers, and are forced onto HTTP. Reasoning effort still tops out at xhigh (no max). The endpoint is undocumented and may violate OpenAI\'s terms or risk suspension; disable to roll back if anything breaks.',
